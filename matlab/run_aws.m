function run_aws(weight, imsize, iters, init, org_clr, con_layers, sty_layers,HOSTNAME)
if nargin == 0
    weight = 500;
    imsize = 513;
    iters = 100;
...
cmd_th = ['time th neural_style.lua ' ...
    ...
    '-style_layers %s ' ...
    '-seed 123 '];
cmd_th = sprintf(cmd_th,init,iters,weight,imsize, org_clr, con_layers, sty_layers); 
